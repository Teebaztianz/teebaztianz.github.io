...
if ( ! function_exists( 'icycp_consultup_slider' ) ) :
	function icycp_consultup_slider() {
		...
		$slider_btn_consultuprget = get_theme_mod('slider_btn_consultuprget',false);
		$slider_enabled = get_theme_mod('slider_enabled','on');
		if($slider_enabled !='off'){	
		?>
  ...
  <section class="consultup-slider-warraper">
    ...
    <div id="consultup-slider" class="owl-carousel"> 
       <!--item-->
        ...
        <!--/slide image-->
        <!--slide inner-->
        <div class="consultup-slider-inner" style="background:<?php echo esc_attr($slider_overlay_color);?>">
                ...
                <div>
				 ...
				 <?php } if($slider_btn_txt) {?>
                  <a <?php if($slider_btn_link) { ?> href="<?php echo $slider_btn_link; } ?>" 
						<?php if($slider_btn_consultuprget) { ?> consultuprget="_blank" <?php } ?> class="btn btn-tislider">
			  ...
			  <div class="col-sm-4 col-md-4 swing animated service-one">
                <div class="consultup-service three text-left">
                  <div class="consultup-service-inner">
					...
					$ser_one_btn_consultupb = get_theme_mod('ser_one_btn_consultupb',false);
					if($ser_one_btn_text !='')
					{ ?>
					<a href="<?php echo esc_url($ser_one_btn_link); ?>" <?php if($ser_one_btn_consultupb == true){ echo 'consultuprget="_blank"';}?> class="btn btn-theme"><?php echo $ser_one_btn_text ; ?></a>	
					<?php } ?>
			  ...
			  <div class="col-sm-4 col-md-4 swing animated service-two">
                <div class="consultup-service three text-left">
                  <div class="consultup-service-inner">
					...
					$ser_two_btn_consultupb = get_theme_mod('ser_two_btn_consultupb',false);
					if($ser_two_btn_text !='')
					{ ?>
					<a href="<?php echo esc_url($ser_two_btn_link); ?>" <?php if($ser_two_btn_consultupb == true){ echo 'consultuprget="_blank"';}?> class="btn btn-theme"><?php echo $ser_two_btn_text ; ?></a>	
					<?php } ?>
					</div>
				</div>
			  </div>
			  <div class="col-sm-4 col-md-4 swing animated service-three">
                <div class="consultup-service three text-left">
                  <div class="consultup-service-inner">
					...
					$ser_three_btn_consultupb = get_theme_mod('ser_three_btn_consultupb',false);
					if($ser_three_btn_text !='')
					{ ?>
					<a href="<?php echo esc_url($ser_three_btn_link); ?>" <?php if($ser_three_btn_consultupb == true){ echo 'consultuprget="_blank"';}?> class="btn btn-theme"><?php echo $ser_three_btn_text ; ?></a>	
					<?php } ?>
                </div>
              </div>
			</div>
...
if ( ! function_exists( 'icycp_consultup_callout' ) ) :
	...
	function icycp_consultup_callout() {
		...
		$callout_btn_consultuprget = get_theme_mod('callout_btn_consultuprget',true);
...
if ( ! function_exists( 'icycp_consultup_portfolio' ) ) :
	...
	function icycp_consultup_portfolio() {
		...
		$home_portfolio_section_title = get_theme_mod('home_portfolio_section_title',__('Our Portfolio','icyclub'));
		$home_portfolio_section_discription = get_theme_mod('home_portfolio_section_discription','laoreet ipsum eu laoreet. ugiignissimat Vivamus dignissim feugiat erat sit amet convallis.');
...
<section class="consultup-portfolio consultup-section grey-bg no-padding text-center">
    <div class="container">
      <div class="row">
		...
		<div class="col-md-12 wow fadeInDown animated padding-bottom-20">
            <div class="consultup-heading">
              <h3 class="consultup-heading-inner"><?php echo $home_portfolio_section_title; ?></h3>
			  <p><?php echo $home_portfolio_section_discription; ?></p>
			</div>
