...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php printf(esc_html__( 'Ready to publish your first post? Get started here.','sauna-lite'), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
	<?php elseif ( is_search() ) : ?>
		...
		<?php get_search_form(); ?>
	<?php else : ?>
		<p><?php esc_html_e( 'Dont worry it happens to the best of us.', 'sauna-lite' ); ?></p><br />
