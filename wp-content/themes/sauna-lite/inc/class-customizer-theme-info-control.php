...
if ( ! class_exists( 'Sauna_Lite_Theme_Info' ) ) :

	/**
	 * Sauna_Lite_Theme_Info class.
	 */
	class Sauna_Lite_Theme_Info extends WP_Customize_Control {
		...
		/**
		 * Sauna_Lite_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Sauna_Lite_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'sauna-lite-style', get_template_directory_uri() . '/inc/css/sauna-style.css', '1.0.0' );
		}
