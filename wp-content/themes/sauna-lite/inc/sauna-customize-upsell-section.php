 ...
 */
/**
 * Class Sauna_Lite_Customizer_Upsell_Section
 */
class Sauna_Lite_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * sauna_lite_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Sauna_Lite_Customizer_Upsell_Section' );
