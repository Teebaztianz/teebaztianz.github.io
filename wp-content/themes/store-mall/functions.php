...
if ( ! function_exists( 'store_mall_setup' ) ) :
	...
	function store_mall_setup() {
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
				'name' => esc_html__( 'Blue', 'store-mall' ),
				'slug' => 'blue',
				'color' => '#49bcd9',
	       	),
	       	array(
	           	'name' => esc_html__( 'Green', 'store-mall' ),
	           	'slug' => 'green',
	           	'color' => '#07d79c',
	       	),
	       	array(
	           	'name' => esc_html__( 'Orange', 'store-mall' ),
	           	'slug' => 'orange',
	           	'color' => '#ff8737',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'store-mall' ),
	           	'slug' => 'black',
	           	'color' => '#2f3633',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'store-mall' ),
	           	'slug' => 'grey',
	           	'color' => '#82868b',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'store-mall' ),
		       	'shortName' => esc_html__( 'S', 'store-mall' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'store-mall' ),
		       	'shortName' => esc_html__( 'M', 'store-mall' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'store-mall' ),
		       	'shortName' => esc_html__( 'L', 'store-mall' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'store-mall' ),
		       	'shortName' => esc_html__( 'XL', 'store-mall' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function store_mall_scripts() {
	...
	// blocks
	wp_enqueue_style( 'store-mall-blocks', get_template_directory_uri() . '/assets/css/blocks.css' );
 ...
 */
function store_mall_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'store-mall-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks.css' ) );
	// Add custom fonts.
	wp_enqueue_style( 'store-mall-fonts', store_mall_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'store_mall_block_editor_styles' );
